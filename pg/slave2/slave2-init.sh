...
cp /docker-entrypoint-initdb.d/config/slave2/postgresql.conf /var/lib/postgresql/data/postgresql.conf
cp /docker-entrypoint-initdb.d/config/slave2/standby.signal /var/lib/postgresql/data/standby.signal
